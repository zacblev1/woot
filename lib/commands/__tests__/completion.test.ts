...
describe('getCompletions - game completion', () => {
  it('returns all games for "game "', async () => {
    ...
    expect(completions).toEqual(['number', 'wordle', 'trivia', 'blackjack', 'rps', 'tron', 'pacman', 'basketball', 'typespeed', 'snake', 'doom'])
  })
  ...
  it('returns filtered games for partial "game t"', async () => {
    ...
    expect(completions).toEqual(['trivia', 'tron', 'typespeed'])
  })
